...
if __name__ == '__main__':
    ...
    axis.plot(x, ideal, marker='.', label='ideal')
    axis.plot(x, before_map, marker='.', label='variation')
    axis.plot(x, bi_map, marker='.', label='bi-map')
    axis.plot(x, bi_retrain, marker='.', label='bi-retrain')
